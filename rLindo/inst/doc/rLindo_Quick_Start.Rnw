...
\section{Usage}
To use the package users must have a valid license file named lndapixyz.lic under the folder LINDOAPI\_HOME/license. The R interface function names use the convention of 'r' + name of LINDO API function, 
